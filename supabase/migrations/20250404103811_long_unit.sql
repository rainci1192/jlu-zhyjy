/*
  # Add initial about content and navigation items

  1. Changes
    - Add initial navigation items for About section
    - Add initial content for About pages
...
-- Insert navigation items for About section
DO $$
DECLARE
  about_id uuid;
BEGIN
