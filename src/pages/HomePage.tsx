...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#014c85] to-[#0066b3] text-white">
      {/* Top Bar */}
      <div className="bg-[#014c85] shadow-lg">
        <div className="container mx-auto px-4 py-2 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <div className="text-2xl font-bold">吉林大学珠海研究院</div>
              <div className="text-base text-gray-300">Zhuhai Institute of Jilin University</div>
            </div>
          </div>
          <div className="hidden md:flex items-center space-x-6">
            <a href="#" className="text-lg hover:text-gray-300 transition-colors">学校主页</a>
            <div className="relative">
              <input
                type="text"
                placeholder="搜索..."
                className="bg-white/10 rounded-full px-4 py-1.5 pl-10 text-base focus:outline-none focus:ring-2 focus:ring-white/20 transition-all w-48"
              />
            ...
            <div className="md:hidden">
              <div className="relative">
                <input
                  type="text"
                  placeholder="搜索..."
                  className="bg-white/10 rounded-full px-4 py-1.5 pl-10 text-base focus:outline-none focus:ring-2 focus:ring-white/20 transition-all w-40"
                />
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4" />
              </div>
            </div>
